window.ARTICLES = {
  "articles": [
    ...
    {
      "slug": "tinybenchmarks",
      "path": "articles/tinybenchmarks/index.html",
      "title": "tinyBenchmarks 少考幾題：用 100 道精選題與試題反應理論，估出整份基準的分數",
      "summary": "University of Michigan、IBM Research、MIT 等機構在 2024 年的論文（ICML 2024）：大型語言模型的基準動輒上萬題，每個新模型都考完整份非常昂貴。作者借用心理計量學的試題反應理論（IRT），用已經考過的模型的作答紀錄挑出有代表性的題，再用 IRT 預測沒考的題；在 Open LLM Leaderboard、MMLU、HELM、AlpacaEval 2.0 四個基準上，每個情境 100 題，平均估計誤差約 2%，並釋出四個 tiny 版與估計工具。每章一張圖解卡加詳細說明，可切換「只看圖卡」。",
      "source": {
        "name": "arXiv · Felipe Maia Polo、Lucas Weber、Leshem Choshen、Yuekai Sun、Gongjun Xu、Mikhail Yurochkin（University of Michigan、University of Pompeu Fabra、IBM Research、MIT、MIT-IBM Watson AI Lab）",
      ...
      "extras": [
        {
          "label": "圖解卡連續閱讀版",
          "path": "articles/tinybenchmarks/cards.html"
        }
      ]
    },
    {
    ...
    {
      "slug": "swe-smith-training-data",
      "path": "articles/swe-smith-training-data/index.html",
      "title": "SWE-smith：先建執行環境再合成 bug，為軟體工程 agent 造出五萬個訓練任務",
      "summary": "Stanford、Princeton 等團隊的 SWE-smith 把 SWE-bench 的收集順序反過來：每個 Python repo 先用 SWE-agent 建一次執行環境，再用 LM 改寫、AST 變換、合併 bug、反轉 PR 等方法合成會弄壞測試的 bug，跑測試驗證後讓 LM 寫 issue，從 128 個 repo 造出約五萬個任務，環境只佔 295 GB。作者用 Claude 3.7 Sonnet 產生專家軌跡、只留解出來的 5,016 條微調 Qwen 2.5 Coder 32B，在 SWE-bench Verified 拿到 40.2%，並用消融比較 bug 種類、issue 寫法、難度與 repo 數對訓練效果的影響。每章一張圖解卡加詳細說明，可切換「只看圖卡」。",
      "source": {
        "name": "arXiv · John Yang、Kilian Lieret、Carlos E. Jimenez、Alexander Wettig、Kabir Khandpur、Yanzhe Zhang、Binyuan Hui、Ofir Press、Ludwig Schmidt、Diyi Yang（Stanford University、Princeton University、Alibaba Qwen、獨立研究者）",
      ...
      "extras": [
        {
          "label": "圖解卡連續閱讀版",
          "path": "articles/swe-smith-training-data/cards.html"
        }
      ]
    },
    {
    ...
    },
    {
      ...
      "path": "articles/multi-agent-failures/index.html",
      "title": "多代理系統為什麼失敗：從 1,642 條執行軌跡歸納出 14 種失敗模式",
      "summary": "UC Berkeley 團隊讀了七個開源多代理框架的執行軌跡，用紮根理論歸納出多代理系統的失敗分類法 MAST：14 種失敗模式，分成系統設計、代理間協調、任務驗證三類，再用 o1 當標註者擴大成 1,642 條軌跡的 MAST-Data。作者用它比較不同系統、模型與任務的失敗分布，並在 AG2 與 ChatDev 上試了改 prompt 與改拓樸兩種修法：有改善，但幅度有限。每章一張圖解卡加詳細說明，可切換「只看圖卡」。",
      "source": {
        "name": "arXiv · Mert Cemri、Melissa Z. Pan、Shuyi Yang、Lakshya A Agrawal、Bhavya Chopra、Rishabh Tiwari、Kurt Keutzer、Aditya Parameswaran、Dan Klein、Kannan Ramchandran、Matei Zaharia、Joseph E. Gonzalez、Ion Stoica（UC Berkeley、Intesa Sanpaolo）",
      ...
      "extras": [
        {
          "label": "圖解卡連續閱讀版",
          "path": "articles/multi-agent-failures/cards.html"
        }
      ]
    },
    {
      "slug": "mt-bench-llm-judge",
      "path": "articles/mt-bench-llm-judge/index.html",
      "title": "讓 LLM 當評審：MT-bench 與 Chatbot Arena 檢驗 GPT-4 評分和人的一致程度，並拆解評審的偏誤",
      "summary": "以 UC Berkeley 為主的研究團隊（也是 Vicuna 的作者）在 2023 年系統性地研究「讓強的 LLM 當評審」：他們建了兩個以人的偏好為準的基準，80 題多輪問題的 MT-bench 與群眾匿名對戰的 Chatbot Arena，比較 GPT-4 等評審和人的判斷，也逐一檢查位置、冗長、自我偏好與數學題評不準這些限制和緩解做法。結果是 GPT-4 和人的一致程度超過 80%，和人與人之間相當。這份整理逐章重述三種評審方式、偏誤的測法、一致程度的算法與結果，每章一張圖解卡加詳細說明，可切換「只看圖卡」。",
      "source": {
        "name": "arXiv · Lianmin Zheng、Wei-Lin Chiang、Ying Sheng、Siyuan Zhuang、Zhanghao Wu、Yonghao Zhuang、Zi Lin、Zhuohan Li、Dacheng Li、Eric P. Xing、Hao Zhang、Joseph E. Gonzalez、Ion Stoica（UC Berkeley、UC San Diego、Carnegie Mellon University、Stanford、MBZUAI）",
      ...
      "extras": [
        {
          "label": "圖解卡連續閱讀版",
          "path": "articles/mt-bench-llm-judge/cards.html"
        }
      ]
    },
    {
    ...
    },
    {
      ...
      "path": "articles/mem0-long-term-memory/index.html",
      "title": "Mem0：長期記憶不靠更長的脈絡，靠從對話抽出、會更新的事實",
      "summary": "Mem0 團隊在 2025 年發表自家的長期記憶系統：每收到一對訊息就抽出值得記的事實，再和最像的舊記憶比對，由 LLM 決定新增、更新、刪除或不動；圖記憶版本 Mem0g 另把事實存成實體與關係。作者在 LOCOMO 基準上和 RAG、全脈絡、A-Mem、LangMem、Zep、OpenAI 記憶等六類對手比較，說 Mem0 的品質接近全脈絡，p95 延遲與 token 都少九成以上。這份整理交代每類對手的跑法與讀數字時要留意的地方，每章一張圖解卡加詳細說明，可切換「只看圖卡」。",
      "source": {
        "name": "arXiv · Prateek Chhikara、Dev Khant、Saket Aryan、Taranjeet Singh、Deshraj Yadav（Mem0）",
      ...
      "extras": [
        {
          "label": "圖解卡連續閱讀版",
          "path": "articles/mem0-long-term-memory/cards.html"
        }
      ]
    },
    {
    ...
    },
    {
      ...
      "summary": "Meta AI 等機構在 2023 年的論文：只用 1,000 筆精選的 prompt 與回答，以一般的監督式微調調整 65B 的 LLaMa，沒有強化學習。在 300 題的人評裡，LIMA 贏過 Alpaca 65B 與 DaVinci003，和 GPT-4 比有 43% 的題目相等或較好；消融顯示提升輸入的多樣性與回答的品質有效，同樣的資料加到 16 倍分數卻持平。作者據此提出表面對齊假說：知識幾乎都在預訓練學會，對齊教的是和使用者互動時用哪一種格式。每章一張圖解卡加詳細說明，可切換「只看圖卡」。",
      "source": {
        "name": "arXiv · Chunting Zhou、Pengfei Liu、Puxin Xu、Srini Iyer、Jiao Sun、Yuning Mao、Xuezhe Ma、Avia Efrat、Ping Yu、Lili Yu、Susan Zhang、Gargi Ghosh、Mike Lewis、Luke Zettlemoyer、Omer Levy（Meta AI、Carnegie Mellon University、University of Southern California、Tel Aviv University）",
      ...
      "extras": [
        {
          "label": "圖解卡連續閱讀版",
          "path": "articles/lima-less-is-more/cards.html"
        }
      ]
    },
    {
      "slug": "good-lm-benchmarks",
      "path": "articles/good-lm-benchmarks/index.html",
      "title": "Good LM Benchmarks：題目要自然、答案能自動判、上線時要夠難",
      "summary": "Ofir Press 2024 年的部落格文章，談怎麼做出好的語言模型 benchmark：三個主要性質是題目自然、答案能自動判對錯、上線時夠難，另有不怕外洩的加分條件、讓人好懂好跑的發布準則，以及文末把一個 task 拆成要求、環境、停止條件、評分器的四元組；「夠難」一節後來補了三次修訂，門檻一路往下調。每章一張圖解卡加詳細說明，可切換「只看圖卡」。",
      "source": {
        "name": "ofir.io · Ofir Press",
      ...
      "extras": [
        {
          "label": "圖解卡連續閱讀版",
          "path": "articles/good-lm-benchmarks/cards.html"
        }
      ]
    },
    {
      "slug": "gepa-prompt-evolution",
      "path": "articles/gepa-prompt-evolution/index.html",
      "title": "GEPA：讓模型讀自己的執行軌跡改寫 prompt，少量 rollout 就贏過強化學習",
      "summary": "UC Berkeley、Stanford 等團隊的 GEPA 是一個 prompt 最佳化器：每一輪挑一個候選、只改其中一個模組，讓反思用的 LLM 讀執行軌跡與評分回饋，把教訓寫進指令；候選用 Pareto 前緣保留每一題的贏家，互補的血統還能逐模組合併。在六個任務、Qwen3 8B 與 GPT-4.1 Mini 上，它平均贏過用 24,000 次 rollout 的 GRPO，rollout 最多少 35 倍，總分提升也是 MIPROv2 的兩倍以上。這份整理交代演算法的每一步、實驗怎麼設定、數字取自哪張表，每章一張圖解卡加詳細說明，可切換「只看圖卡」。",
      "source": {
        "name": "arXiv · Lakshya A Agrawal、Shangyin Tan、Dilara Soylu、Noah Ziems、Rishi Khare、Krista Opsahl-Ong、Arnav Singhvi、Herumb Shandilya、Michael J Ryan、Meng Jiang、Christopher Potts、Koushik Sen、Alexandros G. Dimakis、Ion Stoica、Dan Klein、Matei Zaharia、Omar Khattab（UC Berkeley、Stanford、BespokeLabs.ai、Notre Dame、Databricks、MIT）",
      ...
      "extras": [
        {
          "label": "圖解卡連續閱讀版",
          "path": "articles/gepa-prompt-evolution/cards.html"
        }
      ]
    },
    {
    ...
    {
      "slug": "dylan-agent-network",
      "path": "articles/dylan-agent-network/index.html",
      "title": "DyLAN：多 agent 協作的隊伍與溝通結構，都依任務動態決定",
      "summary": "Tsinghua、Georgia Tech 與 Stanford 的研究者提出 DyLAN（COLM 2024）：把多個 LLM agent 的多輪協作寫成時間展開的前饋網路，每一輪是一層、每個 agent 是一個節點。它分兩階段：先讓全部候選 agent 試跑，把同儕評分從最後一層往回傳，算出每個 agent 的貢獻分數並選出隊伍；解題時再由 LLM Ranker 中途刷掉排名在後的 agent，多數一致就提早停止。在程式生成、網頁購物、MMLU 與 MATH 四類任務上，分數都高於對照方法，API 呼叫次數維持中等。每章一張圖解卡加詳細說明，可切換「只看圖卡」。",
      "source": {
        "name": "arXiv · Zijun Liu、Yanzhe Zhang、Peng Li、Yang Liu、Diyi Yang（Tsinghua University、Georgia Institute of Technology、Stanford University、Jiangsu Collaborative Innovation Center for Language Competence）",
      ...
      "extras": [
        {
          "label": "圖解卡連續閱讀版",
          "path": "articles/dylan-agent-network/cards.html"
        }
      ]
    },
    {
    ...
    },
    {
      ...
      "summary": "Stanford 等團隊的 AutoLibra 不先替 agent 設計評估指標，而是收人對執行軌跡的開放式回饋：先把每句回饋對到軌跡裡的行為，再把相近的行為分群成有定義、有好壞例子的指標，交給 LLM 評審打分，並用覆蓋率與冗餘率檢查這組指標漏了什麼、多了什麼。作者拿它和專家設計的分類比，也拿歸納出的指標當目標自動改 agent 的 prompt。這份整理逐章重述方法、後設指標、實驗與限制，每章一張圖解卡加詳細說明，可切換「只看圖卡」。",
      "source": {
        "name": "arXiv · Hao Zhu、Phil Cuvin、Xinkai Yu、Charlotte Ka Yee Yan、Jason Zhang、Diyi Yang（Stanford University、University of Toronto、University of Pennsylvania）",
      ...
      "extras": [
        {
          "label": "圖解卡連續閱讀版",
          "path": "articles/autolibra-agent-metrics/cards.html"
        }
      ]
    },
    {
